...
const AVAILABLE_FIELDS = [
  ...
  { id: 'store_name', label: 'Store Name', group: 'Orders' },
  { id: 'order_date', label: 'Order Date', group: 'Orders' },
  ...
  { id: 'quantity', label: 'Quantity', group: 'Items' },
...
export default function CustomReport() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-6 p-6 border-2 border-dashed rounded-lg text-center text-gray-400">

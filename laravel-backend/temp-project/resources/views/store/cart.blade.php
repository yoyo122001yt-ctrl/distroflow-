...
<div class="container">
    <nav class="store-nav">
        ...
        <a href="{{ route('store.cart') }}" class="active">Cart @if($cart['count'] > 0)<span class="cart-badge">{{ $cart['count'] }}</span>@endif</a>
        ...
        <div class="cart-summary">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div style="display: flex; gap: 0.5rem;">
                    <div>
                        <label style="font-size: 0.875rem; color: #6b7280;">Delivery Date (optional)</label>
                    ...
                    <div>
                        <label style="font-size: 0.875rem; color: #6b7280;">Notes</label>
                        <input type="text" name="notes" placeholder="Optional notes..." style="padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem;">
                    </div>
    ...
    <div class="empty-cart">
        ...
        <a href="{{ route('store.products') }}" class="btn-primary" style="display: inline-block; margin-top: 1rem; text-decoration: none;">Browse Products</a>
    </div>
    @endif
</div>
@endsection

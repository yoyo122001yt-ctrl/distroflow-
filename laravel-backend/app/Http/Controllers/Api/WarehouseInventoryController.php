    ...
    public function adjust(Request $request)
    {
        try {
            ...
            $result = DB::transaction(function () use ($request) {
                ...
                $adjustment = $request->new_quantity - $oldQuantity;

                $batch->update([
                    'available_quantity' => $request->new_quantity,
                    'status' => $request->new_quantity > 0 ? 'available' : 'depleted',
                ...
                WarehouseStockMovement::create([
                    ...
                    'type' => $adjustment >= 0 ? 'addition' : 'removal',
